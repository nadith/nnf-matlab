classdef Tanh < nnet.internal.cnn.layer.Layer
    % Tanh   Rectified Linear Unit layer
    ...
    methods
        function this = Tanh(name)
            % Tanh  Constructor for the layer
            this.Name = name;
            
            this.ExecutionStrategy = TanhHostStrategy();
        end
        ...
        function this = setupForGPUPrediction(this)
            this.ExecutionStrategy = TanhGPUStrategy();
        end
